...
The data_minimized folder (not in the github repo) contains all the data used in the analyses, and is broken up into multiple levels of processing.
...
The figs folder contains the figures and tables included in the manuscript and supplemental materials that were generated using code.